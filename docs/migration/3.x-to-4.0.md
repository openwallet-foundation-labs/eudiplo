...
See [Key Management](../architecture/key-management.md) for full configuration.
...
- [Open an issue](https://github.com/openwallet-foundation-labs/eudiplo/issues/new?template=bug_report.md) for migration problems
- [Join the discussion](https://github.com/openwallet-foundation-labs/eudiplo/discussions) for questions
