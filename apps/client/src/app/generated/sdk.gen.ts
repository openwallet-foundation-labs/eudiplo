 ...
 */
export const tenantControllerGetTenantStatus = <ThrowOnError extends boolean = false>(options?: Options<TenantControllerGetTenantStatusData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TenantControllerGetTenantStatusResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
