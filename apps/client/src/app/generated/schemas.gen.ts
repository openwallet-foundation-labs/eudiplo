...
export const Oauth2AuthorizationServerResponseDtoSchema = {
    type: 'object',
    properties: {
        issuer: {
            type: 'string',
        ...
        token_endpoint_auth_methods_supported: {
            ...
            items: {
                anyOf: [
                    {
                        type: 'string',
                        enum: ['client_secret_basic', 'client_secret_post', 'attest_jwt_client_auth', 'client_secret_jwt', 'private_key_jwt']
                    },
                    {
                        type: 'string'
                    }
