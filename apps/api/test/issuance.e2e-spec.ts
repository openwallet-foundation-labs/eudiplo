...
describe('Issuance', () => {
  ...
  beforeAll(async () => {
    ...
    const pidCredentialConfiguration = JSON.parse(
      readFileSync('assets/config/root/issuance/credentials/pid.json', 'utf-8')
    );
    ...
    const pidIssuanceConfiguration = JSON.parse(
      readFileSync('assets/config/root/issuance/issuance/pid.json', 'utf-8')
    );
    ...
    const citizenIssuanceConfiguration = JSON.parse(
      readFileSync('assets/config/root/issuance/issuance/citizen.json', 'utf-8')
    );
  ...
  test('pre authorized code flow', async () => {
    ...
    await client.sendNotification({
      ...
      notification: {
        ...
        notificationId: credentialResponse.credentialResponse.notification_id!,
